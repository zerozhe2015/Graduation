...
public class RoundProgressBar extends View {
	...
	public RoundProgressBar(Context context, AttributeSet attrs, int defStyle) {
		...
		//获取自定义属性和默认值
		roundColor = mTypedArray.getColor(R.styleable.RoundProgressBar_roundColor,getResources().getColor(R.color.newblack));
		...
		textSize = mTypedArray.getDimension(R.styleable.RoundProgressBar_textSize, 55);
